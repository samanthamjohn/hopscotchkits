...
{"id"=>28,
 ...
 "updated_at"=>"2012-03-13 18:53:04 UTC",
...
{"id"=>32,
 ...
 "updated_at"=>"2012-03-14 15:46:49 UTC",
...
{"id"=>29,
 "kit_id"=>7,
 "description"=>"We're going to give the workspace a nickname: \"paper\". This is so that we can tell it what to do later. This is common in programming&mdash; you'll use a nickname so that you can talk to a piece of code later on in your program. \r\n\r\nSo now go back to line 1 and change it to:\r\n\r\n<code>paper = makeWorkspace()</code>",
 "spec"=>"",
...
{"id"=>33,
 "kit_id"=>7,
 "description"=>"Here's something new: <code>alert</code>.\r\n\r\nAlert is built into your browser. It will open a popup window with whatever words you put inside the parentheses. Let's try it out&mdash; type: \r\n\r\n<code>alert(\"Woohoo I'm a popup!\")</code>",
 "spec"=>"",
...
{"id"=>45,
 ...
 "updated_at"=>"2012-03-27 16:15:34 UTC",
...
{"id"=>44,
 ...
 "updated_at"=>"2012-03-27 16:07:43 UTC",
 "title"=>"More holes!",
...
{"id"=>51,
 ...
 "updated_at"=>"2012-03-27 17:06:44 UTC",
 "title"=>"Start button",
 "hint"=>"",
...
{"id"=>52,
 "kit_id"=>10,
 "description"=>"Now we actually want to use the start button to start our game. Add these lines<code><add>button.click( () ->\r\n&nbsp;&nbsp;button.hide()\r\n&nbsp;&nbsp;text.hide()\r\n&nbsp;&nbsp;showMole()\r\n)\r\ntext.click( () ->\r\n&nbsp;&nbsp;button.hide()\r\n&nbsp;&nbsp;text.hide()\r\n&nbsp;&nbsp;showMole()\r\n)</add></code>\r\n\r\nThis should go at the very end of your program. ",
 "spec"=>nil,
 "success_message"=>"Click start and see what happens.",
 "position"=>10,
 "created_at"=>"2012-03-26 14:27:59 UTC",
 "updated_at"=>"2012-03-27 17:18:28 UTC",
...
{"id"=>43,
 "kit_id"=>10,
 "description"=>"We need holes for the moles to pop out of. Type this:\r\n<code><add>molehole = paper.circle(50,50,30)\r\nmolehole.attr('fill':'navy', 'stroke-width': 0)</add></code>",
 "spec"=>nil,
 "success_message"=>"Try changing the parameters of the circle (the numbers in parentheses) by highlighting them and using the up/down arrows on your keyboard. \r\nSee if you can figure out what each of the numbers controls.",
 "position"=>3,
 "created_at"=>"2012-03-23 14:47:27 UTC",
 "updated_at"=>"2012-03-27 15:56:35 UTC",
 "title"=>"Mole hole",
...
{"id"=>42,
 ...
 "updated_at"=>"2012-03-27 15:53:02 UTC",
 "title"=>"Background Color",
...
{"id"=>49,
 ...
 "updated_at"=>"2012-03-27 16:26:09 UTC",
...
{"id"=>48,
 ...
 "updated_at"=>"2012-03-27 16:19:19 UTC",
...
{"id"=>54,
 "kit_id"=>10,
 "description"=>"*IMPORTANT*\r\nIn the samples below, the green lines should be added to your code. The non-colored lines are already in your code and are just for reference.  <code> <add>count = 0</add>\r\nshowMole = ->\r\n&nbsp;&nbsp;mole.animate\r\n&nbsp;&nbsp;&nbsp;&nbsp;x:6 + random(), y:10 + random(), 1700, \r\n&nbsp;&nbsp;&nbsp;&nbsp;() -> \r\n&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;mole.show()\r\n<add>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;setTimeout(( ->\r\n&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;mole.hide()  \r\n&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;count++\r\n&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if count < 15\r\n&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;showMole()\r\n&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;else \r\n&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;count = 0\r\n&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;), 900)</add>\r\nshowMole()</code>\r\n\r\nIf you're having trouble, try deleting the end of your code, starting at showMole = -> and pasting in the entire example. \r\n",
 "spec"=>nil,
 ...
 "updated_at"=>"2012-03-27 16:56:30 UTC",
 "title"=>"Move the mole",
...
{"id"=>53,
 ...
 "updated_at"=>"2012-03-27 17:25:29 UTC",
 "title"=>"Keep score",
 "hint"=>"",
 "solution"=>"paper = makeWorkspace() \r\nbackground = paper.rect(0,0,400,400) \r\nbackground.attr('fill':'deepskyblue')\r\nmolehole = paper.circle(50,50,30).attr('fill':'navy', 'stroke-width': 0)\r\n_(4).times( (i) ->\r\n&nbsp;&nbsp;_(4).times( (j) ->\r\n&nbsp;&nbsp;&nbsp;&nbsp;moveLeft = i * 100\r\n&nbsp;&nbsp;&nbsp;&nbsp;moveRight = j * 100\r\n&nbsp;&nbsp;&nbsp;&nbsp;molehole.clone().transform(\"T\" + moveLeft + \",\" + moveDown)\r\n&nbsp;&nbsp;)\r\n)\r\nmole = paper.image('http://localhost:5000/assets/mole.png', 6, 10, 80, 80)\r\n$('body').append($(\"&lt;div id='sound'&gt;\"))\r\nplaySound = (src) ->\r\n&nbsp;&nbsp;$(\"#sound\").html(\"&lt;embed src='\"+src+\"' hidden='true' autostart='true' loop='false'&gt;\")<br />\r\nscore = 0\r\nmole.click(->\r\n&nbsp;&nbsp;playSound(\"http://localhost:5000/assets/punch.wav\")\r\n&nbsp;&nbsp;score++\r\n)\r\nmole.hide()\r\nrandom = ->\r\n&nbsp;&nbsp;Math.floor(Math.random() * 4) * 100\r\ncount = 0\r\nshowMole = ->\r\n&nbsp;&nbsp;mole.animate\r\n&nbsp;&nbsp;&nbsp;&nbsp;x:6 + random(), y:10 + random(), 1700, \r\n&nbsp;&nbsp;&nbsp;&nbsp;() ->\r\n&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;mole.show()\r\n&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;setTimeout(( ->\r\n&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;mole.hide()  \r\n&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;count++\r\n&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if count < 15\r\n&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;showMole()\r\n&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;else \r\n&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;count = 0\r\n&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;button.show()\r\n&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;text.attr(\"text\":\"Score: \" + score)\r\n&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;text.show()\r\n&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;), 900)\r\nbutton = paper.rect(123, 170, 150, 60)\r\nbutton.attr(\"fill\":'deeppink', 'stroke':'white', 'stroke-width':'3', 'r':12)\r\ntext = paper.text(200, 200, \"Start\" )\r\ntext.attr('font-size':24, 'font-family':'monospace', 'fill': 'yellowgreen', 'font-weight':'bold')\r\nbutton.click( () ->\r\n&nbsp;&nbsp;button.hide()\r\n&nbsp;&nbsp;text.hide()\r\n&nbsp;&nbsp;showMole()\r\n)\r\ntext.click( () ->\r\n&nbsp;&nbsp;button.hide()\r\n&nbsp;&nbsp;text.hide()\r\n&nbsp;&nbsp;showMole()\r\n)",
 "image_url"=>"",
