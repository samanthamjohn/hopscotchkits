...
{"id"=>49,
 "kit_id"=>10,
 "description"=>"Let's write some code so that the mole will pop up in a random spot\r\n\r\nrandom = ->\r\n&nbsp;&nbsp;Math.floor(Math.random() * 4) * 100\r\nshowMole = -> \r\n  mole.animate \r\n    x:6 + random(), y:10 + random(), 1700,\r\n    () ->   \r\n      mole.show() \r\nshowMole()\r\n<code>mole.hide()\r\nrandom = ->\r\n&nbsp;&nbsp;Math.floor(Math.random() * 4) * 100\r\nshowMole = ->\r\n&nbsp;&nbsp;mole.animate\r\n&nbsp;&nbsp;&nbsp;&nbsp;x:6 + random(), y:10 + random(), 1700, \r\n&nbsp;&nbsp;&nbsp;&nbsp;() ->\r\n&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;mole.show()\r\nshowMole()\r\n</code>",
 "spec"=>nil,
 "success_message"=>"",
 "position"=>7,
 "created_at"=>"2012-03-23 21:55:04 UTC",
 "updated_at"=>"2012-03-23 22:37:33 UTC",
...
{"id"=>44,
 ...
 "updated_at"=>"2012-03-23 21:35:29 UTC",
 "title"=>"More holes!",
...
{"id"=>50,
 "kit_id"=>10,
 "description"=>"Now to make the game run. Let's have the mole pop up and down 15 times. Change: <code> showMole = -></code> to <code>count = 0\r\nshowMole = -></code>\r\n\r\nNext we will add some code to make the mole show and hide 15 times. Change the end of your code to read: \r\n<code>mole.animate \r\n&nbsp;&nbsp;x:6 + random(), y:10 + random(), 1700, () -> \r\n&nbsp;&nbsp;&nbsp;&nbsp;mole.show()\r\n&nbsp;&nbsp;&nbsp;&nbsp;setTimeout(( ->\r\n&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;mole.hide()  \r\n&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;count++\r\n&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if count < 15\r\n&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;showMole() \r\n&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;else \r\n&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;count = 0\r\n&nbsp;&nbsp;&nbsp;&nbsp;), 900)</code>\r\nHighlight that last chunk of code and press tab to ensure that it is indented 2 spaces in from the definition for showMole, the same way it was before.\r\nThe last line should still be <code>showMole()</code> with no indent.",
 "spec"=>nil,
 "success_message"=>"",
 "position"=>8,
 "created_at"=>"2012-03-26 13:53:06 UTC",
 "updated_at"=>"2012-03-26 14:24:13 UTC",
 "title"=>"Move the mole",
 "hint"=>"",
 "solution"=>"",
 "image_url"=>"",
...
{"id"=>52,
 "kit_id"=>10,
 "description"=>"Now we actually want to use the start button to start our game. <code>button.click( () ->\r\n&nbsp;&nbsp;button.hide()\r\n&nbsp;&nbsp;text.hide()\r\n&nbsp;&nbsp;showMole()\r\n)\r\ntext.click( () ->\r\n&nbsp;&nbsp;button.hide()\r\n&nbsp;&nbsp;text.hide()\r\n&nbsp;&nbsp;showMole()\r\n)</code>\r\n\r\nThis should go at the very end of your program. ",
 "spec"=>nil,
 "success_message"=>"",
 "position"=>10,
 "created_at"=>"2012-03-26 14:27:59 UTC",
 "updated_at"=>"2012-03-26 14:31:50 UTC",
...
{"id"=>51,
 "kit_id"=>10,
 "description"=>"Lastly we want to be able to start this game any time rather than automatically starting it. \r\nFirst remove the line from: <code><s>showMole()</s></code>  \r\nThen we'll draw a button:\r\n<code>button = paper.rect(123, 170, 150, 60)\r\nbutton.attr(\"fill\":'deeppink', 'stroke':'white', 'stroke-width':'3', 'r':12)\r\ntext = paper.text(200, 200, \"Start\" )\r\ntext.attr('font-size':24, 'font-family':'monospace', 'fill': 'yellowgreen', 'font-weight':'bold')</code>",
 "spec"=>nil,
 "success_message"=>"",
 "position"=>9,
 "created_at"=>"2012-03-26 14:25:50 UTC",
 "updated_at"=>"2012-03-26 14:32:17 UTC",
 "title"=>"Start button",
 "hint"=>"",
 "solution"=>"",
 "image_url"=>"",
...
{"id"=>41,
 ...
 "updated_at"=>"2012-03-23 14:03:00 UTC",
 "title"=>"Make a paper",
...
{"id"=>43,
 "kit_id"=>10,
 "description"=>"We need holes for the moles to pop out of. Type this:\r\n<code>molehole = paper.circle(50,50,30)\r\nmolehole.attr('fill':'navy', 'stroke-width': 0)</code>",
 "spec"=>nil,
 "success_message"=>"",
 "position"=>3,
 "created_at"=>"2012-03-23 14:47:27 UTC",
 "updated_at"=>"2012-03-23 21:57:50 UTC",
 "title"=>"Mole hole",
 "hint"=>"",
