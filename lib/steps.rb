...
{"id"=>13,
 ...
 "updated_at"=>"2012-03-13 21:38:49 UTC",
...
{"id"=>17,
 ...
 "updated_at"=>"2012-03-13 20:45:38 UTC",
...
{"id"=>45,
 ...
 "updated_at"=>"2012-03-28 16:30:05 UTC",
...
{"id"=>15,
 "kit_id"=>3,
 "description"=>"The ears look a little droopy&mdash; let's try to rotate them. \r\n\r\n<code> .ellipse </code> has a method called <code> .rotate </code> where you can rotate the object. \r\n\r\nTry \r\n\r\n<code>rightEar.rotate(\"90\")</code>. \r\n\r\nNow adjust the angle so that it looks just like the picture. Do the same with the left ear.\r\n",
 "spec"=>"assert( (-> \r\n  rotatedEllipses = 0\r\n  _.each($frame.find(\"svg ellipse\"), (ellipse)-> \r\n    if $(ellipse).attr(\"transform\") \r\n      rotatedEllipses += 1\r\n  )\r\n  if rotatedEllipses < 2\r\n    return false\r\n  else\r\n    return true\r\n), \"You need to rotate both ears\")",
 "success_message"=>"You successfully used <code>rotate</code>. When you use \"20\" you rotated the ear 20&deg; clockwise. When you use \"-20\" you will rotate it 20&deg; counter-clockwise. Pretty cool huh?",
 "position"=>6,
 "created_at"=>"2012-01-06 15:46:21 UTC",
 "updated_at"=>"2012-03-13 20:44:54 UTC",
 "title"=>"Perk up the ears",
 "hint"=>"For the left ear try <code>leftEar.rotate(\"-80\")</code>, see if you can adjust that negative angle to match the picture. ",
 "solution"=>"paper = makeWorkspace()\r\n\r\nleftEar=paper.ellipse(150,215,40,80)\r\nleftEar.attr(\"fill\", \"saddleBrown\")\r\nrightEar=paper.ellipse(250,215,40,80)\r\nrightEar.attr(\"fill\", \"saddleBrown\")\r\n\r\nleftEar.rotate(\"20\")\r\nrightEar.rotate(\"-20\")\r\n\r\n\r\nface = paper.ellipse(200,200,60,80)\r\nface.attr(\"fill\", \"saddlebrown\")\r\n",
 "image_url"=>"step6.png",
 "bonus"=>false,
 "freeplay"=>false,
...
{"id"=>16,
 ...
 "position"=>7,
 "created_at"=>"2012-01-06 16:15:57 UTC",
 "updated_at"=>"2012-03-13 20:45:18 UTC",
 "title"=>"Puppy eyes",
 "hint"=>"Try this for the left eye, see if you can mirror it on the right. \r\n\r\n<code>\r\nleftEyeOuter = paper.ellipse(175, 175, 12,15)\r\nleftEye = paper.circle(175, 170, 7)\r\n</code>",
 "solution"=>"paper = makeWorkspace()\r\n\r\nleftEar=paper.ellipse(150,215,40,80)\r\nleftEar.attr(\"fill\", \"saddleBrown\")\r\nrightEar=paper.ellipse(250,215,40,80)\r\nrightEar.attr(\"fill\", \"saddleBrown\")\r\n\r\nleftEar.rotate(\"20\")\r\nrightEar.rotate(\"-20\")\r\n\r\n\r\nface = paper.ellipse(200,200,60,80)\r\nface.attr(\"fill\", \"saddlebrown\")\r\n\r\n\r\nleftEyeOuter = paper.ellipse(175, 175, 12,15).attr(\"fill\", \"white\")\r\nleftEye = paper.circle(175, 170, 7).attr(\"fill\", \"black\")\r\nrightEyeOuter = paper.ellipse(225, 175, 12,15).attr(\"fill\", \"white\")\r\nrightEye = paper.circle(225, 170, 7).attr(\"fill\", \"black\")",
 "image_url"=>"step7.png",
...
{"id"=>12,
 ...
 "position"=>3,
 "created_at"=>"2012-01-06 00:39:08 UTC",
 "updated_at"=>"2012-03-13 21:38:16 UTC",
 "title"=>"Adding Some Color",
