...
{"id"=>48,
 ...
 "updated_at"=>"2012-03-26 15:50:16 UTC",
 ...
 "bonus"=>false,
 "freeplay"=>false,
 "more_info"=>"If you want to play a different sound all you need to do is find a link to a sound file on the internet. Then change \r\n<code>playSound(\"http://localhost:5000/assets/punch.wav\"</code>to use the url to your new sound file."},
{"id"=>44,
 "kit_id"=>10,
 "description"=>"Whack-a-mole with only one hole is not that interesting. Let's make some more:\r\n<code><add>_(4).times( (i) ->\r\n&nbsp;&nbsp;_(4).times( (j) ->\r\n&nbsp;&nbsp;&nbsp;&nbsp;moveLeft = i * 100\r\n&nbsp;&nbsp;&nbsp;&nbsp;moveRight = j * 100\r\n&nbsp;&nbsp;&nbsp;&nbsp;molehole.clone().transform(\"T\" + moveLeft + \",\" + moveRight)\r\n&nbsp;&nbsp;)\r\n)</add></code>",
 "spec"=>nil,
 "success_message"=>"",
 "position"=>4,
 "created_at"=>"2012-03-23 14:52:38 UTC",
 "updated_at"=>"2012-03-26 16:12:43 UTC",
 "title"=>"More holes!",
 "hint"=>"The spacing here is very important. Make sure it's exactly the same as in the example.",
 "solution"=>"_(4).times( (i) ->\r\n&nbsp;&nbsp;_(4).times( (j) ->\r\n&nbsp;&nbsp;&nbsp;&nbsp;moveLeft = i * 100\r\n&nbsp;&nbsp;&nbsp;&nbsp;moveRight = j * 100\r\n&nbsp;&nbsp;&nbsp;&nbsp;molehole.clone().transform(\"T\" + moveLeft + \",\" + moveRight)\r\n&nbsp;&nbsp;)\r\n)",
 "image_url"=>"",
 "bonus"=>false,
 "freeplay"=>false,
 "more_info"=>""},
{"id"=>45,
 ...
 "updated_at"=>"2012-03-26 16:12:51 UTC",
...
{"id"=>49,
 ...
 "updated_at"=>"2012-03-26 16:22:45 UTC",
 "title"=>"Where's the mole?",
 "hint"=>"Pay careful attention to open and closing parentheses. Each opening paren must match up with a closing paren. ",
 "solution"=>"",
 "image_url"=>"",
 "bonus"=>false,
 "freeplay"=>false,
...
{"id"=>52,
 ...
 "updated_at"=>"2012-03-26 16:36:10 UTC",
...
{"id"=>51,
 "kit_id"=>10,
 "description"=>"We want to be able to start this game any time rather than automatically starting it. Let's change the end of our code: \r\n<code><delete>-showMole()</delete><add>button = paper.rect(123, 170, 150, 60)\r\nbutton.attr(\"fill\":'deeppink', 'stroke':'white', 'stroke-width':'3', 'r':12)\r\ntext = paper.text(200, 200, \"Start\" )\r\ntext.attr('font-size':24, 'font-family':'monospace', 'fill': 'yellowgreen', 'font-weight':'bold')</add></code>",
 "spec"=>nil,
 "success_message"=>"",
 "position"=>9,
 "created_at"=>"2012-03-26 14:25:50 UTC",
 "updated_at"=>"2012-03-26 16:36:17 UTC",
 "title"=>"Start button",
 "hint"=>"",
 "solution"=>"",
 "image_url"=>"",
...
{"id"=>53,
 ...
 "updated_at"=>"2012-03-26 16:41:23 UTC",
 "title"=>"Keep score",
 "hint"=>"",
 "solution"=>"",
 "image_url"=>"",
...
{"id"=>41,
 ...
 "updated_at"=>"2012-03-26 16:12:05 UTC",
 "title"=>"Make a paper",
...
{"id"=>43,
 ...
 "updated_at"=>"2012-03-26 16:12:23 UTC",
 "title"=>"Mole hole",
 "hint"=>"",
 "solution"=>"paper = makeWorkspace() \r\nbackground = paper.rect(0,0,400,400) \r\nbackground.attr('fill':'blue')\r\nmolehole = paper.circle(50,50,30).attr('fill':'greenyellow', 'stroke-width': 0)",
 "image_url"=>"",
 "bonus"=>false,
 "freeplay"=>false,
 "more_info"=>""},
...
{"id"=>54,
 "kit_id"=>10,
 "description"=>"Now to make the game run. Let's have the mole pop up and down 15 times. First add this line to your code: <code> <add>count = 0</add>\r\nshowMole = ->\r\n&nbsp;&nbsp;mole.animate</code>\r\nNext we will add some code to make the mole show and hide 15 times. Change the end of your code to read: \r\n<code>&nbsp;&nbsp;mole.animate\r\n&nbsp;&nbsp;&nbsp;&nbsp;x:6 + random(), y:10 + random(), 1700, \r\n&nbsp;&nbsp;&nbsp;&nbsp;() -> \r\n&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;mole.show()\r\n<add>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;setTimeout(( ->\r\n&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;mole.hide()  \r\n&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;count++\r\n&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if count < 15\r\n&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;showMole()\r\n&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;else \r\n&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;count = 0\r\n&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;), 900)</add>\r\nshowMole()</code>\r\nMake sure that the indentation is consistent or your code will not work properly. ",
 "spec"=>nil,
 "success_message"=>"",
 "position"=>8,
 "created_at"=>"2012-03-26 15:16:56 UTC",
 "updated_at"=>"2012-03-26 16:24:49 UTC",
 "title"=>"Move the mole",
 "hint"=>"The green colored text refers to code you should add in. The text that is not highlighted refers to existing code that should stay the same.",
 "solution"=>"",
 "image_url"=>"",
 "bonus"=>false,
 "freeplay"=>false,
