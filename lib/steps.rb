...
[
  ...
  {"id"=>31,
    ...
    "updated_at"=>"2012-02-29 20:13:01 UTC",
  ...
  {"id"=>36,
    "kit_id"=>7,
    "description"=>"Now that we know how to write a question let's add more to the quiz. \r\n\r\nIn the last question we wrote code and told click to run it when we clicked on the answer. \r\n\r\nAll it does right now is create an alert. What if it also took you to the next question?",
    "spec"=>"",
    ...
    "updated_at"=>"2012-03-01 17:32:59 UTC",
    "title"=>"Next!",
    "hint"=>"Make sure that when you set the background color the second time it is inline with the alert. If not, it won't work. ",
    "solution"=>"paper = makeWorkspace()\r\nbg = paper.rect(0,0,400, 400)\r\nbg.attr('fill', 'yellow')\r\nquestion = paper.text(200, 50, \"How cold is it today?\")\r\n\r\nanswer1 = paper.text(200, 80, \"a little nippy out there\") \r\nanswer2 = paper.text(200, 120, \"spring-like\") \r\nanswer3 = paper.text(200, 160, \"watch out for global warming\") \r\n\r\nanswer3.click(->\r\n&nbsp;&nbsp;alert(\"Correct!\")\r\n&nbsp;&nbsp;background = paper.rect(0,0,400,400)\r\n&nbsp;&nbsp;background.attr('fill', 'yellow')\r\n)\r\n",
    "image_url"=>"",
    "bonus"=>false,
    "freeplay"=>false,
    "more_info"=>"Let's start out with making a new background for the new question. Change your click to read: \r\n<code>\r\nanswer3.click( ->\r\n&nbsp;&nbsp;alert(\"Correct!\")\r\n&nbsp;&nbsp;background = paper.rect(0,0,400,400)\r\n&nbsp;&nbsp;background.attr('fill', 'yellow')</code>\r\n)\r\n  \r\nWe are doing the exact same thing we did to make the first background, except this time it's yellow!"},
  {"id"=>37,
    "kit_id"=>7,
  ...
  {"id"=>38,
    ...
    "updated_at"=>"2012-03-01 17:34:38 UTC",
    ...
    "bonus"=>false,
    "freeplay"=>false,
    "more_info"=>"What we'll do is add a click to answer2 (or whichever one is right). We'll have to make another function with the code we want to save for when the  \r\n\r\n<code>\r\n\r\n\r\nanswer3.click( ->\r\n&nbsp;&nbsp;[...your code...]\r\n&nbsp;&nbsp;answer2.click(->\r\n&nbsp;&nbsp;&nbsp;&nbsp;alert(\"correct!\")\r\n&nbsp;&nbsp;)\r\n)"},
  {"id"=>39,
    "kit_id"=>7,
    "description"=>"Congratulations, you now know the basics of creating a quiz. Let's continue to improve it! \r\n\r\nHere are some resources to help you out: \r\n\r\n<a href=\"http://raphaeljs.com/reference.html\" target=\"_blank\">Raphael</a> is the library we used to to make the paper, the rectangles, the text and  click on things. Check here for some more good stuff (you could try an image question perhaps). \r\n\r\n",
    "spec"=>nil,
    "success_message"=>"",
    "position"=>12,
    "created_at"=>"2012-03-01 18:20:31 UTC",
    "updated_at"=>"2012-03-01 18:20:31 UTC",
    "title"=>"Let your creativity flow",
    "hint"=>"",
    "solution"=>"",
    "image_url"=>"",
