...
describe SignupsController do
  ...
  describe "#index" do
    it "should show all the signups grouped by source and ordered by date" do
      user = User.create(role: "admin", name: "sam")
      session[:user_id] = user.id
      Signup.create(source: "homepage", email: "foo@bar.com")
      Signup.create(source: "astro_defenders", email: "foo2@bar.com")
      get :index
      assigns(:signups).should == Signup.group("source").order("created_at DESC")
    end
  end
